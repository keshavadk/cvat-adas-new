...
from cvat_adas_demo.engine.media_extractors import (Mpeg4ChunkWriter,
    Mpeg4CompressedChunkWriter, ZipChunkWriter, ZipCompressedChunkWriter,
    ImageDatasetManifestReader, VideoDatasetManifestReader)
from cvat_adas_demo.engine.models import DataChoice, StorageChoice
...
from cvat_adas_demo.engine.utils import md5_hash
class CacheInteraction:
    ...
    def prepare_chunk_buff(self, db_data, quality, chunk_number):
        from cvat_adas_demo.engine.frame_provider import FrameProvider # TODO: remove circular dependency
        writer_classes = {
